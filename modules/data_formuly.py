...
def add_user(id = None, username = None, genero = None, edad = None,  fecha = None, correo = None):
    ...
    nombre_de_archivo = f"{username}-{id}-{edad}-{fecha}-{genero}-{correo}.json"
    datos = store_string(
        "user/users",
        nombre_de_archivo,
...
def add_encuesta(encuesta = None, id = None, pregunta_1 = None, pregunta_2 = None, pregunta_3 = None):
    ...
    nombre_de_archivo = f"{encuesta}-{id}-{id}-{id}-{id}.json"
    datos = store_string(
        "enuesta/encuestas",
        nombre_de_archivo,
        json.dumps(almacenable)
...
def add_repuestas(encuesta = None, id = None, respuesta_1 = None, respuesta_2 = None, respuesta_3 = None):
    ...
    nombre_de_archivo = f"{encuesta}-{id}-{respuesta_1}.json"
    datos = store_string(
        "enuesta/respuestas",
        nombre_de_archivo,
        json.dumps(almacenable)
